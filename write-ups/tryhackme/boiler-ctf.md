...
Since we have two HTTP service running, i started off with the native port 80
 ...
 ![Joomla](../../assets/images/Boiler_ctf/joomla.png)
...
I also want to point out that, if you were stuck, it's okay, we all learn somewhere, take this write-up as a way of learning something new, the key to enumeration is to look, levera../../assets